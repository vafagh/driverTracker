<div class="modal-body">
    <div class="form-group">
        ...
        <input name="name" class="form-control form-control" type="text" required autocomplete='name'>
    </div>
    ...
    <div class="form-group">
        ...
        <input name="phone" class="form-control form-control" type="text" required autocomplete='tel'>
    </div>
    ...
    <div class="form-group">
        ...
        <input name="line2" class="mt-1 form-control form-control" type="text" placeholder="Line 2" autocomplete='address-line2'>
